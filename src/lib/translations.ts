...
export const translations = {
    pl: {
        ...
        contactForm: {
            title: 'Zamów Aimorę',
            subtitle: 'Bez płatności online i bez zobowiązań — odezwiemy się w 24 h, żeby potwierdzić szczegóły',
            pricePerSet: 'zł / zestaw — detektor trafień + moduł LED + 2 odbłyśniki',
            chooseProduct: 'Wybierz produkt',
            productSingleName: 'Zestaw',
            productSingleDesc: 'detektor trafień + moduł LED + 2 odbłyśniki',
            productBundleName: 'Pakiet 4 zestawów',
            productBundleDesc: '4 detektory + 4 moduły LED + 16 odbłyśników (8 gratis)',
            productReflectorsName: 'Pakiet odbłyśników',
            productReflectorsDesc: '2 odbłyśniki zapasowe',
            youSave: 'Oszczędzasz',
            perSingle: 'zestaw',
            perBundle: 'pakiet',
            ...
            messagePlaceholder: 'np. potrzebuję faktury na firmę, pytanie o termin dostawy...',
            promoPrice: 'Cena',
            total: 'Razem',
            submit: 'Wyślij zamówienie — płatność później',
            submitting: 'Wysyłanie...',
            successTitle: 'Mamy Twoje zamówienie!',
            successMessage: 'W ciągu 24 h odezwiemy się mailowo lub telefonicznie, żeby potwierdzić szczegóły i formę płatności.',
            close: 'Zamknij',
            errorMessage: 'Nie udało się wysłać formularza. Spróbuj ponownie lub napisz do nas: biuro@aimora.pl',
            contactInfo: 'Żadnych płatności teraz — w ciągu 24 h potwierdzimy zamówienie mailowo lub telefonicznie',
            required: '*'
        },
        rental: {
    ...
    en: {
        ...
        contactForm: {
            title: 'Order Aimora',
            subtitle: 'No online payment, no commitment — we will contact you within 24 h to confirm the details',
            pricePerSet: 'EUR / set — hit detector + LED module + 2 reflectors',
            chooseProduct: 'Choose product',
            productSingleName: 'Set',
            productSingleDesc: 'hit detector + LED module + 2 reflectors',
            productBundleName: '4-Set Bundle',
            productBundleDesc: '4 detectors + 4 LED modules + 16 reflectors (8 free)',
            productReflectorsName: 'Reflector Pack',
            productReflectorsDesc: '2 spare reflectors',
            youSave: 'You save',
            perSingle: 'set',
            perBundle: 'bundle',
            ...
            messagePlaceholder: 'e.g. I need an invoice, question about delivery time...',
            promoPrice: 'Price',
            total: 'Total',
            submit: 'Send Order — Pay Later',
            submitting: 'Sending...',
            successTitle: 'We got your order!',
            successMessage: 'We will contact you within 24 h by email or phone to confirm the details and payment method.',
            close: 'Close',
            errorMessage: 'Failed to send the form. Please try again or email us at biuro@aimora.pl',
            contactInfo: 'No payment now — we will confirm your order within 24 h by email or phone',
            required: '*'
        },
        rental: {

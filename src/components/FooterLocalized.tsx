...
interface FooterLocalizedProps {
    locale: Locale;
}
...
export function FooterLocalized({ locale }: FooterLocalizedProps) {
    const t = getTranslations(locale);

    const footerLinks = {
        product: [
            { name: t.footer.smartDetectors, href: '#' },
            { name: t.footer.mobileApp, href: '#' },
        ],
        legal: [

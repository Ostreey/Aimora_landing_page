...
export function ClientTestVideoSectionLocalized({ locale }: ClientTestVideoSectionLocalizedProps) {
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                <div className="text-center mb-6 sm:mb-8 md:mb-12">
                    <h2 className="text-white font-barlow font-black text-4xl sm:text-5xl md:text-6xl leading-tight mb-4 sm:mb-6">
                        {t.testVideoSection.title} <span className="text-[#017da0]">{t.testVideoSection.titleHighlight}</span>
                    </h2>
                ...
                <div className="relative">
                        ...
                        {!isPlaying ? (
                            <div className="relative w-full h-full">
                                <img
                                    ...
                                    alt={t.testVideoSection.playTestVideo}
                                ...
                                <button
                                    ...
                                    onClick={handlePlay}
                                    aria-label={t.testVideoSection.playTestVideo}
                                >
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="text-center p-6 bg-white/5 rounded-xl backdrop-blur-sm">
                            ...
                            <h4 className="text-white font-barlow font-bold text-lg mb-2">{t.testVideoSection.provenInPractice}</h4>
                            <p className="text-white/70 font-inter text-sm">
                                {t.testVideoSection.provenDesc}
                            </p>
                        </div>
                        ...
                        <div className="text-center p-6 bg-white/5 rounded-xl backdrop-blur-sm">
                            ...
                            <h4 className="text-white font-barlow font-bold text-lg mb-2">{t.testVideoSection.appControl}</h4>
                            <p className="text-white/70 font-inter text-sm">
                                {t.testVideoSection.appControlDesc}
                            </p>
                        </div>
                        ...
                        <div className="text-center p-6 bg-white/5 rounded-xl backdrop-blur-sm">
                            ...
                            <h4 className="text-white font-barlow font-bold text-lg mb-2">{t.testVideoSection.easySetup}</h4>
                            <p className="text-white/70 font-inter text-sm">
                                {t.testVideoSection.easySetupDesc}
                            </p>
                        </div>
                    </div>
                </div>

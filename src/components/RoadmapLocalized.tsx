...
export function RoadmapLocalized({ locale }: RoadmapLocalizedProps) {
    ...
    const roadmapItems = [
        {
            date: '07.2025',
            title: t.roadmap.items.firstVersion.title,
            description: t.roadmap.items.firstVersion.description,
            icon: Target,
            status: 'completed',
        ...
        {
            date: '11.2025',
            title: t.roadmap.items.newGameSeries.title,
            description: t.roadmap.items.newGameSeries.description,
            icon: Calendar,
            status: 'completed',
